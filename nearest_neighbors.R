...
# that is not exported I need to import myself. So any get_global_variable
# will not work and has been changed to what it would have been, that being:
#
# 'nn_control_annoy_euclidean': list(method='annoy', metric='euclidean', n_trees=50, M=48, ef_construction=200, ef=150, grain_size=1, cores=1)
#
